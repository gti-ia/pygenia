...
exp_data <- read.csv(file="Sweden_experiment_data.csv",head=TRUE, sep=";")
...
pdf("sweden/sweden_fear_boxplot.pdf")
CircularBoxplot(g_fear)
dev.off()
pdf("sweden/sweden_anger_boxplot.pdf")
CircularBoxplot(g_anger)
dev.off()
pdf("sweden/sweden_disgust_boxplot.pdf")
CircularBoxplot(g_disgust)
dev.off()
pdf("sweden/sweden_sadness_boxplot.pdf")
CircularBoxplot(g_sadness)
dev.off()
pdf("sweden/sweden_boredom_boxplot.pdf")
CircularBoxplot(g_boredom)
dev.off()
pdf("sweden/sweden_sleepiness_boxplot.pdf")
CircularBoxplot(g_sleepiness)
dev.off()
pdf("sweden/sweden_calm_boxplot.pdf")
CircularBoxplot(g_calm)
dev.off()
pdf("sweden/sweden_happiness_boxplot.pdf")
CircularBoxplot(g_happiness)
dev.off()
pdf("sweden/sweden_excitement_boxplot.pdf")
CircularBoxplot(g_excitement)
dev.off()
pdf("sweden/sweden_surprise_boxplot.pdf")
...
for (emocion in emociones) {
  pdf(paste0("sweden/sweden_", emocion, "_hist.pdf"))  # Guardar el gráfico en un archivo PDF
  p <- ggplot() +
...
pdf("sweden/sweden_fear_cleaned_boxplot.pdf")
CircularBoxplot(c1_fear)
dev.off()
pdf("sweden/sweden_anger_cleaned_boxplot.pdf")
CircularBoxplot(c1_anger)
dev.off()
pdf("sweden/sweden_disgust_cleaned_boxplot.pdf")
CircularBoxplot(c1_disgust)
dev.off()
pdf("sweden/sweden_sadness_cleaned_boxplot.pdf")
...
pdf("sweden/sweden_boredom_cleaned_boxplot.pdf")
unique(c1_boredom)
i=1
i=i+1
CircularBoxplot(g_boredom[-c(41)])
dev.off()
pdf("sweden/sweden_sleepiness_cleaned_boxplot.pdf")
CircularBoxplot(c1_sleepiness)
dev.off()
pdf("sweden/sweden_calm_cleaned_boxplot.pdf")
CircularBoxplot(c1_calm)
dev.off()
pdf("sweden/sweden_happiness_cleaned_boxplot.pdf")
CircularBoxplot(c1_happiness)
dev.off()
pdf("sweden/sweden_excitement_cleaned_boxplot.pdf")
CircularBoxplot(c1_excitement)
dev.off()
pdf("sweden/sweden_surprise_cleaned_boxplot.pdf")
CircularBoxplot(c1_surprise)
dev.off()

r_boredom <- g_boredom[!g_boredom %in% c1_boredom]
i = 1
for (e in r_boredom){
  print(e)
  if (i == 3) {
  CircularBoxplot(g_boredom[!g_boredom %in% c(e)])
  }
  i = i+1
}
...
pdf("sweden/sweden_density_distribution.pdf", width = 10, height = 5)
...
title(main = "Density Estimation Sweden Model", font.main = 2)
...
# Estimar la densidad para c1_anger
estimacion_densidad_anger <- density(c1_anger)
pdf("sweden/sweden_density_distribution_normalized.pdf", width = 10, height = 5)
