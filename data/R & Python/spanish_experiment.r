...
exp_data <- read.csv(file="spanish.csv",head=TRUE, sep=";")
...
pdf("spanish/spanish_fear_boxplot.pdf")
CircularBoxplot(g_fear)
dev.off()
pdf("spanish/spanish_anger_boxplot.pdf")
CircularBoxplot(g_anger)
dev.off()
pdf("spanish/spanish_disgust_boxplot.pdf")
CircularBoxplot(g_disgust)
dev.off()
pdf("spanish/spanish_sadness_boxplot.pdf")
CircularBoxplot(g_sadness)
dev.off()
pdf("spanish/spanish_boredom_boxplot.pdf")
CircularBoxplot(g_boredom)
dev.off()
pdf("spanish/spanish_sleepiness_boxplot.pdf")
CircularBoxplot(g_sleepiness)
dev.off()
pdf("spanish/spanish_calm_boxplot.pdf")
CircularBoxplot(g_calm)
dev.off()
pdf("spanish/spanish_happiness_boxplot.pdf")
CircularBoxplot(g_happiness)
dev.off()
pdf("spanish/spanish_excitement_boxplot.pdf")
CircularBoxplot(g_excitement)
dev.off()
pdf("spanish/spanish_surprise_boxplot.pdf")
...
for (emocion in emociones) {
  pdf(paste0("spanish/spanish_", emocion, "_hist.pdf"))  # Guardar el gráfico en un archivo PDF
  p <- ggplot() +
...
pdf("spanish/spanish_fear_cleaned_boxplot.pdf")
CircularBoxplot(c1_fear)
dev.off()
pdf("spanish/spanish_anger_cleaned_boxplot.pdf")
CircularBoxplot(c1_anger)
dev.off()
pdf("spanish/spanish_disgust_cleaned_boxplot.pdf")
CircularBoxplot(c1_disgust)
dev.off()
pdf("spanish/spanish_sadness_cleaned_boxplot.pdf")
CircularBoxplot(c1_sadness)
dev.off()
pdf("spanish/spanish_boredom_cleaned_boxplot.pdf")
CircularBoxplot(c1_boredom)
dev.off()
pdf("spanish/spanish_sleepiness_cleaned_boxplot.pdf")
CircularBoxplot(c1_sleepiness)
dev.off()
pdf("spanish/spanish_calm_cleaned_boxplot.pdf")
CircularBoxplot(c1_calm)
dev.off()
pdf("spanish/spanish_happiness_cleaned_boxplot.pdf")
CircularBoxplot(c1_happiness)
dev.off()
pdf("spanish/spanish_excitement_cleaned_boxplot.pdf")
CircularBoxplot(c1_excitement)
dev.off()
pdf("spanish/spanish_surprise_cleaned_boxplot.pdf")
...
for (em in unique(dataframe$variables)){
  ...
  resultado_watson <- kuiper.test(circular(data2$valores))
  print(resultado_watson)
}
...
pdf("spanish/spanish_density_distribution.pdf", width = 10, height = 5)
...
title(main = "Density Estimation Spanish Model", font.main = 2)
...
# Estimar la densidad para c1_anger
estimacion_densidad_anger <- density(c1_anger)
pdf("spanish/spanish_density_distribution_normalized.pdf", width = 10, height = 5)
